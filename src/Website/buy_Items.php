...
<head>
    ...
    <link rel="stylesheet"
         ...
         <p><a href="http://ecs.fullerton.edu/~cs332u1">Return to Homepage</a></p>
</head>
...
//var_dump($sqlRand, $sql0, $sql1, $result);
      ...
      {
        $sql3 = "INSERT INTO Transactions VALUES( \"". $tID ."\" , '". $tDate . "' , '". $tTime . "', \"" . $cuID ."\");";
// ======= Test Query ===========
//echo "<br><br>$sql3";
// ==============================
        $sql2 = "INSERT INTO TransactWith VALUES(\"".$tID."\" , \"".$upc."\" , \"". $purchasedItems . "\", \"". $numberOfItems ."\" , \"". $cuID . "\");";
// ======= Test Query ===========
//echo "<br><br>$sql2";
// ==============================
...
if($resultQ3 == 'True')
        {
          echo "Query Successfully Inserted! <br><br> Query:  $sql2 ";
        }
...
Query: INSERT INTO TransactWith VALUES("521" , "000000000001" , "2", "2" , "22222");
=================== resultQ3 ===================
Connection Sucessful!
